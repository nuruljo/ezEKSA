...
class bahagianE1 extends StatefulWidget {
  @override
  _bahagianE1State createState() => _bahagianE1State();
}
...
class _bahagianE1State extends State<bahagianE1> {
/////////////////////////////////// value dropdown ////////////////////////////////////////////////////////
  ///1
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title:
              Text("Komponen E1 - Agensi Mempunyai Bangunan & Kawasan Sendiri"),
        ),
        body: ListView(
                    ...
                    return AlertDialog(
                        ...
                        actions: <Widget>[
                          FlatButton(
                              child: Text("Ya"),
                              onPressed: () =>
                                  Navigator.pushNamed(context, '/bahagianE2')),
                          FlatButton(
                              child: Text("Tidak"),
                              onPressed: () =>
