...
class bahagianA7 extends StatefulWidget {
  @override
  _bahagianA7State createState() => _bahagianA7State();
}
...
class _bahagianA7State extends State<bahagianA7> {
/////////////////////////////////// value dropdown ////////////////////////////////////////////////////////
  ///1
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Komponen A7 - Tindakan Penjimatan/Go Green"),
        ),
        body: ListView(
              ...
              showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      content: Text("Adakah anda ingin ke Bahagian B?"),
                      actions: <Widget>[
                        FlatButton(
                            child: Text("Ya"),
                            onPressed: () =>
                                Navigator.pushNamed(context, '/bahagianB')),
                        FlatButton(
                            child: Text("Tidak"),
                            onPressed: () {
                              showDialog(
                                            ...
                                            showDialog(
                                              ...
                                              builder: (context) {
                                                return AlertDialog(
                                                    title: Text("Kepastian"),
                                                    content: Text(
                                                        "Adakah anda ingin ke Bahagian D?"),
                                                    actions: <Widget>[
                                                      FlatButton(
                                                          child: Text("Ya"),
                                                          onPressed: () =>
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return AlertDialog(
                                                                                ...
                                                                                actions: <Widget>[
                                                                                  ...
                                                                                  FlatButton(child: Text("Tidak"), onPressed: () => Navigator.pushNamed(context, '/results')),
                                                                                ],
                                                                              );
                                                                            },
                                                                          );
